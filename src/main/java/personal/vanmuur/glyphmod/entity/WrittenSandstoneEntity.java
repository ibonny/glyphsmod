package personal.vanmuur.glyphmod.entity;
...
public class WrittenSandstoneEntity extends BlockEntity {
    public WrittenSandstoneEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.WRITTEN_SANDSTONE_ENTITY.get(), pos, state);
    }
